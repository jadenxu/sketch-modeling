                                      ...
                                      const arma::mat& searchDirection)
{
  ...
  {
    cout << "L-BFGS line search direction is not a descent direction "
                                      ...
                                      const size_t maxIterations)
{
  ...
  for (size_t itNum = 0; optimizeUntilConvergence || (itNum != maxIterations);
       ++itNum)
  {
    cout << "L-BFGS iteration " << itNum << "; objective " <<
        function.Evaluate(iterate) << "." << std::endl;

    // Break when the norm of the gradient becomes too small.
    if (GradientNormTooSmall(gradient))
    {
      cout << "L-BFGS gradient norm too small (terminating successfully)."
          << std::endl;
      break;
    }
    ...
    {
      cout << "Line search failed.  Stopping optimization." << std::endl;
    ...
    {
      cout << "L-BFGS step size of 0 (terminating successfully)."
          << std::endl;
      break;
    }
